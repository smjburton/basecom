...
Class base_XML_FreeThreadedDomDocument
	Private p_objFreeThreadedDomDocument

	Private Sub Class_Initialize()
		Set p_objFreeThreadedDomDocument = CreateObject("Msxml2.FreeThreadedDOMDocument.6.0")
	End Sub
	...
	Public Property Get FirstChild()
		Set DocumentElement = p_objFreeThreadedDomDocument.firstChild
	End Property
	...
	Public Property Get NodeTypedValue()
		If IsObject(p_objFreeThreadedDomDocument.nodeTypedValue) Then
			p_objFreeThreadedDomDocument.nodeTypedValue
		Else
			p_objFreeThreadedDomDocument.nodeTypedValue
		End If
	End Property
	...
	Public Function ImportNode( _
		...
		Set ImportNode = p_objFreeThreadedDomDocument.importNode(objNode, blnDeep)
	End Function
	...
	Public Function InsertBefore( _
		...
		Set InsertBefore = p_objFreeThreadedDomDocument.insertBefore(objNewChild, varRefChild)
	End Function
	...
	Public Function ValidateNode( _
		...
		Set ValidateNode = p_objFreeThreadedDomDocument.validateNode(objNode)
	End Function
...
If WScript.ScriptName = "base_XML_FreeThreadedDomDocument.vbs" Then
